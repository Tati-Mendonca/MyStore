...
export default function Home() {
  return (
    <div className="grid max-h-[860px] grid-cols-9 grid-rows-6 gap-6">
      <Link
        href="/"
        className="group relative col-span-6 row-span-6 rounded-lg bg-zinc-200 overflow-hidden flex justify-center items-end"
      >
        <Image
      ...
      <Link
        href="/"
        className="group relative col-span-3 row-span-3 rounded-lg bg-zinc-200 overflow-hidden flex justify-center items-end"
      >
        <Image
          className="group-hover:scale-105 transition-transform duration-500"
          src="/black T-shirt.png"
